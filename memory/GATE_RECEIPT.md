...
- **Waktu:** 2026-08-18 14:31:54
- **Mode:** `full`  ·  **Durasi total:** 276s  ·  **Pekerja statik:** 2
...
| check_nav_map (navigasi vs SSOT) | PASS (1s) |
...
| audit_entity_isolation SELF-TEST (bukti-merah pagar isolasi) | PASS (0s) |
| guard:write_scope SELF-TEST (INV-ENTITY-02, mode gabungan hanya-lihat) | PASS (1s) |
...
| POC FASE F-6 (pensiun mesin generik · 14 antrean nyata · anti dobel-hitung) | FAIL (2s) |
| POC FASE F-6.7 (langkah Ajukan payroll & desain · selisih bayar · verifikasi SO) | FAIL (5s) |
...
| guard:approval_queues (INV-APPR-01, tiap pintu keputusan punya antrean) | FAIL (1s) |
| guard:concurrency (INV-CONC-01, race/TOCTOU uang) | PASS (1s) |
| guard:state_machine (INV-STATE-01, transisi SO) | PASS (1s) |
| audit_endpoint_sweep (semua GET → 5xx · paralel) | PASS (3s) |
| health_check (isi endpoint kritis) | PASS (3s) |
| INV-GATE-01 anti-residu (gate tak boleh merusak data) | PASS (0s) |
...
| POC FASE F (R&D · labdip/proofing · lifecycle produk) | FAIL (12s) |
...
| seed_realistic (pulihkan data demo setelah FASE POC) | PASS (12s) |
| verify_data_integrity (ulang, pasca pemulihan data) | PASS (3s) |
